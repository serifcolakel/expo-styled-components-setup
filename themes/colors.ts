...
/**
 * @description Base colors for the app
 */
export const appColors = {
  primary: colorPalette.blue[800],
  secondary: colorPalette.green[500],
  light: colorPalette.gray[100],
  dark: colorPalette.gray[900],
  tint: colorPalette.blue[500],
  tabIconDefault: colorPalette.gray[400],
  tabIconSelected: colorPalette.blue[500],
...
/**
 * @description light and dark theme colors must be same key names
 */
export const colors = {
  light: {
